...
void UQuadTree::Clear()
{
	...
	if (mSubdivided)
	{
		for (int32 i = 0; i < 4; i++)
		{
			// UObject will be garbage collected
			mpNodes[i] = nullptr;
		}
		mSubdivided = false;
	}
